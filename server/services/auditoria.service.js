...
const registrarAuditoria = async (req, p_id, p_login, modulo, accion, registro_afectado, detalle) => {
    try {
        ...
        await pool.query(
            `INSERT INTO auditoria_general (usuario_login, modulo, accion, registro_afectado, detalle, ip_cliente, dispositivo) VALUES ($1, $2, $3, $4, $5, $6, $7)`,
            [usuario_login, modulo, accion, registro_afectado, detalle, ip_cliente, dispositivo]
        );
    } catch (error) {
        console.error(error);
    }
